...
void I2C_Initialization(void){
	...
	RCC->CCIPR &= ~(0x3 << 12);
	RCC->CCIPR |= 0x1 << 12; //enable system clock as I2C clock source
	...
	//I2C Parameters
	I2C1->CR1 &= ~I2C_CR1_PE; //DISABLE I2C WHILE MODIFYING VALUES
	I2C1->CR1 &= ~I2C_CR1_ANFOFF; //turn on analog noise filter
	I2C1->CR1 &= ~I2C_CR1_DNF; //turn off digital noise filter
	I2C1->CR1 |= I2C_CR1_ERRIE; //turn on error interrupts
	I2C1->CR1 &= ~I2C_CR1_NOSTRETCH; //enable clock stretching
	I2C1->CR2 &= ~I2C_CR2_ADD10; //enable 7-bit addressing mode
	...
	//set Prescaler to 7, so that tpresc = 1*10^(-7) sec
	I2C1->TIMINGR |= 7 << I2C_TIMINGR_PRESC_POS;
	
	//t_time * f_presc = Time+1
	I2C1->TIMINGR |= 9 << I2C_TIMINGR_SCLDEL_POS; //set SCLDEL 
	I2C1->TIMINGR |= 12 << I2C_TIMINGR_SDADEL_POS; //set SDADEL
	I2C1->TIMINGR |= 39 << I2C_TIMINGR_SCLH_POS; //SET SCLH
	I2C1->TIMINGR |= 46 << I2C_TIMINGR_SCLL_POS; //SET SCLL
	
	//SETTING ADDRESSES
	I2C1->OAR1 |= I2C_OAR1_OA1EN; //ENABLE OWNADDRESS 1
	I2C1->OAR1 &= ~I2C_OAR2_OA2EN; //DISABLE OWNADDRESS 2
	
	I2C1->OAR1 &= ~I2C_OAR1_OA1MODE; //7 BIT ADDRESSING MODE
	I2C1->OAR1 &= ~I2C_OAR1_OA1; //set OA1[7:0] TO OwnAddr 
	I2C1->OAR1 |= OwnAddr << 0; 
